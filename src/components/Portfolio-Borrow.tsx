    ...
    <div className="borrow_history_main_card">
      ...
      <div className="right_borrow_card_history">
        <div className="right_borrow_card_history1">
          <div className="borrow_card_name">
            {loan.NFTName} <small>#{loan.Id}</small>
          </div>
        ...
        <div className="right_borrow_card_history2">
          <div>
            Token Contract <br />
            <div className="borrow_small">{loan.TokenContract}</div>
          </div>
          <div>
            TokenID
            <br />
            <div className="borrow_small">{loan.TokenId}</div>
          </div>
        </div>
        <div className="right_borrow_card_history3">
          <div>
            ...
            <br />
            <span>
              {loan.CollateralValue} ETH{' '}
              <small>
                ({(loan.CollateralValue * loan.EthToUsd).toFixed(2)} USD)
              </small>
            </span>
          </div>
          <div>
        ...
        {isLoading ? (
          ...
          <button
            className="portfolio_borrow_bttn"
            onClick={() => {
              userRepay();
            }}
          >
